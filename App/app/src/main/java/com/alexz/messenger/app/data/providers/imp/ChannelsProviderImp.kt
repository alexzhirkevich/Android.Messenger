...
//        return Completable.concatArray(creationCompletable, userCompletable, adminCompletable, profileCompletable)
    ...
    override fun join(channelId: String): Single<IChannel> {
        ...
        val joinCompletable = doc.set(mapOf(Pair(REFERENCE, usersCollection.document(uid))))
                .toCompletable()
...
interface ChannelsProviderComponent{
    fun getChannelsProvider() : ChannelsProviderImp
}
