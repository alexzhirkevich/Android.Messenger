...
import com.alexz.messenger.app.ui.viewmodels.UserProfileViewModel
...
class UserProfileFragment : MainActivity.EdgeToEdgeFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.init(user.id).data.observe(viewLifecycleOwner, Observer {
            if (it.value != null) {
