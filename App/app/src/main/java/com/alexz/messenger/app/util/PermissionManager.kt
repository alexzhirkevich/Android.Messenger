...
interface PermissionManager {
    ...
    fun shouldShowEducationalDiallog(activity: Activity, permission: String) : Boolean
...
private class PermissionManagerImpl(private val context: Context) : PermissionManager {
    ...
    override fun shouldShowEducationalDiallog(activity: Activity, permission: String): Boolean =
