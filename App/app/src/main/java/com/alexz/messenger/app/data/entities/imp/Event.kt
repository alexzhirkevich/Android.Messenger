...
class Event(
    ...
    override fun toString(): String {
        return "Event(name='$name', imageUri='$imageUri', creatorId='$creatorId', time=$time, address='$address', description='$description', isEnded=$isEnded, isValid=$isValid)"
    }
