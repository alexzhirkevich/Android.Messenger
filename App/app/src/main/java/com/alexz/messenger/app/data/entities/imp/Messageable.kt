...
open class Messageable(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is Messageable) return false
    ...
    companion object CREATOR : Parcelable.Creator<Messageable> {
        override fun createFromParcel(parcel: Parcel): Messageable {
            return Messageable(parcel)
        }

        override fun newArray(size: Int): Array<Messageable?> {
