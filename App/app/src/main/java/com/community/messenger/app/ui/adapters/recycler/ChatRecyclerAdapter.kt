...
import com.community.messenger.core.providers.test.TestMessagesProvider
import com.community.messenger.core.providers.test.TestUsersProvider
import com.community.recadapter.BaseViewHolder
import io.reactivex.android.schedulers.AndroidSchedulers
import io.reactivex.disposables.Disposable
import io.reactivex.schedulers.Schedulers

class ChatRecyclerAdapter : com.community.recadapter.BaseRecyclerAdapter<IChat, ChatRecyclerAdapter.ChatViewHolder>() {
    ...
    inner class ChatViewHolder(itemView: View) : BaseViewHolder<IChat>(itemView) {
        ...
        override fun onBind(entity: IChat) {
            ...
            lastMessageDisposable = messagesProvider.get(chatId, msgID)
                    ...
                    .subscribe(
                            { msg ->
                                ...
                                senderView.append(":")
                                dateView.text = msg.time.dateTime(itemView.context).timeNearly
                            },
                            {
        ...
        private fun setupImage(uri : String, name : String){
            if (uri.isNotEmpty()){
                ...
                imgView.setupWithText(name, R.dimen.font_size_large,R.color.chats)
            }
        }
    }
