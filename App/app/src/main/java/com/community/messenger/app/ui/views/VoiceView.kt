...
import com.community.messenger.app.databinding.ItemVoicePlayerBinding
...
class VoiceView : LinearLayout {
    ...
    init {
        ItemVoicePlayerBinding.inflate(LayoutInflater.from(context))

        inflate(context, R.layout.item_voice_player, this)
        length = 3500
        button = findViewById(R.id.btn_play)
        seekBar = findViewById(R.id.seekbar)
        timer = findViewById(R.id.text_time)
...
//        wave.setRawData(Random.nextBytes(1024))
        ...
        progressAnim = ObjectAnimator.ofInt(seekBar, "progress", 0, 100).apply {
