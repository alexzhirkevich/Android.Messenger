...
//    fun onSelect(key: String, model: Entity): Boolean = true
     ...
     * */
    fun add(entity : Entity, forceCallback: Boolean = false, byUser : Boolean = true) : Int

    fun set(entities: Collection<Entity>)

    fun addAll(entities : Collection<Entity>,forceCallback: Boolean = false, byUser : Boolean = true)
